...
Like other centralized stablecoins such as USDT, Circle implements both **freezing and blacklist** features and gates their redemption mechanism behind KYC. Both issuers also remain the only ones exposed to the sizable yield generated by the collateral.
...
The capture of the stablecoin landscape by centralized actors poses a long-term sustainability risk that Polaris is designed to resolve. Large asset issuers are prone to become kingmakers on the chain they sit on, as we’ve seen with Lido/stETH in the past; and Polaris acts like a double-edged sword in this fight: **it captures raw ETH, and uses it to output trustless stablecoins that scale**.
...
Intrigued? [Follow Polaris on Twitter](https://x.com/polarisfinance_), or join [the Telegram announcement channel](https://t.me/polaris_ann) to keep up with our latest developments.